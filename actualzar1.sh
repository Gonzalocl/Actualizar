...
wget -r --user=gonzalo.caparrosl@um.es --password=66HnVzFq https://aulavirtual.um.es/dav/1898_G_2016_N_N
exit
wget -r -np -nH --reject="index.html*" --cut-dirs=1 --user=gonzalo.caparrosl@um.es --password=66HnVzFq https://aulavirtual.um.es/dav/1898_G_2016_N_N
...
wget -r -nH -np —cut-dirs=1 —user= —password= url
# sasi no comprueba si ya estan descargados los archivos



wget -r -np -nH  --reject="index.html*" --cut-dirs=1 --user=gonzalo.caparrosl@um.es --password= https://aulavirtual.um.es/dav/1898_G_2016_N_N
